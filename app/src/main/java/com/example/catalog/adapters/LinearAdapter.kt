...
class LinearAdapter (private val array: ArrayList<com.example.catalog.models.ModelClass>,
...
RecyclerView.Adapter<LinearAdapter.ViewHolder>() {
    class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        init {
            image = itemView.findViewById(R.id.imageView_third)
            name = itemView.findViewById(R.id.name_third)
            description = itemView.findViewById(R.id.description_third)
        }
    }
